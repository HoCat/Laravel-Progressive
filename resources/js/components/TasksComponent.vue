<template>
    <div class="w-full sm:w-1/2 lg:w-1/3 rounded shadow">
        <h2 class="shadow bg-blue-900 text-gray-100 text-sm py-2 px-4 font-hairline font-mono">Tasks</h2>
        ...
        <form class="w-full text-sm" @submit.prevent="createTask">
            <div class="flex items-center bg-yellow-lighter py-2">
                <input class="appearance-none bg-transparent border-none w-3/4 mr-3 py-1 px-2 font-serif italic"
                       type="text"
